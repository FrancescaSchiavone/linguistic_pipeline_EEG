...
#   - PHONITALIA_PATH: percorso al file datasets/phonitalia.csv
#   - PRIORS_PATH: percorso al file dei prior esterno (questo NON è il file delle coorti)
# ---------------------------------------------------------------------------
STORY_PATH = Path(r"data\phoneme_onset_D\St01_D.xlsx")
STORY_ID = "St01_D"
OUTPUT_ROOT = Path("output_nlp")
OUTPUT_GROUP = "output_D"
PHONITALIA_PATH = Path("datasets/phonitalia.csv")
...
GPU_BATCH_SIZE = 16
MAX_TOKENS_FOR_TEST = 50 # usa x per un test veloce; None processa tutta la storia
...
def compute_all(
    ...
    model_name: str = MODEL_NAME,
    story_id: Optional[str] = STORY_ID,
    ...
    output_base = output_root / output_group / story_id
